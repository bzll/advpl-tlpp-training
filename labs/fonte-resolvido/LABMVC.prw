...
User Function LABMVC()
    ...
    oBrowse:AddLegend("ZZ1_STATUS == '1'", "GREEN", "Ativo")
    oBrowse:AddLegend("ZZ1_STATUS == '2'", "RED"  , "Encerrado")
    oBrowse:Activate()
...
Static Function LABVldCommit(oModel)
    ...
    Local cStatus := oModel:GetValue("ZZ1MASTER", "ZZ1_STATUS")
    ...
    If cStatus == "2" .And. oModel:GetOperation() == MODEL_OPERATION_UPDATE
        Help(Nil, Nil, "VALIDACAO", Nil, "Registro encerrado nao pode ser alterado.", 1, 0)
        Return .F.
    EndIf
